...
(function (global) {
  ...
  async function play(profileOverride) {
    // In Delta Multi-tab mode deo/SC owns the real sockets. Do not open a
    // second isolated FFA WebSocket; it races the SC tabs and causes 1006.
    if (global.__ONYX_DEO_ONLY__) {
      log('DEO_ONLY', 'isolated FFA socket disabled; SC/deo owns Delta tabs');
      return false;
    }
